...
const ManageCommunity = () => {
  ...
  const handleAdd = async () => {
    ...
    try {
      await API.post("/community/add", formData);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await API.put(`/community/${editForm.id}`, formData);
      setShowModal(false);
      fetchCategories();
    } catch (err) {
  ...
  return (
    <div className="container my-4">
      <h2 className="mb-4">Manage Community</h2>

      <div className="card p-4 mb-4">
        <h5 className="card-title">Add New Community Post</h5>
        <div className="mb-3">
            ...
            <div className="card">
              <div className="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                  ...
                  <Link to={`/dashboard/community/post/${cat.id}`}>
